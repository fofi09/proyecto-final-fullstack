...
const Footer = () => {
  return (
    <footer className="bg-[#F9F5E8] py-16">
      ...
      <div className="container mx-auto px-4 w-full max-w-6xl ml-12">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 text-[#333333]">
          ...
          <div className="w-full md:w-1/4">
            <h3 className="font-semibold text-lg mb-6">Newsletter</h3> {/* CAMBIO AQUÍ */}
            ...
            <div className="flex">
              ...
              />
              <button className="bg-[#00715C] text-white py-2 px-6 hover:bg-[#1a6456] transition-colors">
                Subscribe
              </button>
            </div>
          </div>
