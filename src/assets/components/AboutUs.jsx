...
const AboutUs = () => {
  return (
    <section className="bg-[#FAF8F1] py-16 px-4 md:px-16 flex justify-center">
      <div className="flex flex-col md:flex-row items-center w-full max-w-6xl relative">
        ...
        {/* Fondo blanco (independiente, ajustado un poco más arriba abajo) */}
        ...
        <div className="relative w-full md:w-4/5 flex flex-col gap-4 md:gap-8 pl-4 md:pl-12 z-10 mt-12 md:mt-24">
