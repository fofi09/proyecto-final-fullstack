...
const CallToAction = () => {
  return (
    <section
      className="bg-[#00715D] text-white py-12 md:py-12 relative overflow-hidden"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <div className="absolute top-1/2 right-20 transform -translate-y-1/2">
        <button className="bg-[#FCD859] text-black font-semibold py-3 px-8 rounded-none shadow-md hover:bg-yellow-500 transition-colors">
          Donate Now
        </button>
      </div>
    </section>    
